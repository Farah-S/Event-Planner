@extends('layout')
@section('title','brandingEventForm')
@section('content')
...
<div class="contact-section">
    <div class="container border-right border-left">
        <div class="row" style="justify-content:center">
            <div class="col-12">
                <h3 class="slider center-title-events">Branding Event</h3><br>
            </div>
            <div class="col-lg-8">
                <form class="form-contact contact_form" action="{{route('events.storeNewProduct')}}" method="post" id="newProductForm" enctype="multipart/form-data" novalidate="novalidate">
                    @csrf
