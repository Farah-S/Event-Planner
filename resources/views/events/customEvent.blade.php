                    ...
                    <div class="row">
                        ...
                        <h3 class="slider form-item-title">Event Details</h3>
                            <div class="form-group">
                                <textarea class="white-form w-100" style="padding:10px" name="message" minlength=50 id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Event Description'" placeholder="Event Description"></textarea>
                            </div>
                            <div class="form-group">
