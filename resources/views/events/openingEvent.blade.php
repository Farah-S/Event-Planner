...
<div class="contact-section">
    <div class="container border-right border-left">
        <div class="row" style="justify-content:center">
            <div class="col-12">
                <h3 class="slider center-title-events">Opening Event</h3><br>
            </div>
            <div class="col-lg-8">
                <form class="form-contact contact_form" action="{{route('events.OpeningEvent')}}" method="post" id="OpeningEventForm" enctype="multipart/form-data" novalidate="novalidate">
                    @csrf
